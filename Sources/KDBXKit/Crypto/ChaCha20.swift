...
public final class ChaCha20: Encryptable, Decryptable {
    ...
    fileprivate func core(block: inout any MutableDataProtocol, counter: any DataProtocol, key: any DataProtocol) {
        ...
        let j4 = UInt32(bytes: key.slice(0..<4)).bigEndian
        let j5 = UInt32(bytes: key.slice(4..<8)).bigEndian
        let j6 = UInt32(bytes: key.slice(8..<12)).bigEndian
        let j7 = UInt32(bytes: key.slice(12..<16)).bigEndian
        let j8 = UInt32(bytes: key.slice(16..<20)).bigEndian
        let j9 = UInt32(bytes: key.slice(20..<24)).bigEndian
        let j10 = UInt32(bytes: key.slice(24..<28)).bigEndian
        let j11 = UInt32(bytes: key.slice(28..<32)).bigEndian
        let j12 = UInt32(bytes: counter.slice(0..<4)).bigEndian
        let j13 = UInt32(bytes: counter.slice(4..<8)).bigEndian
        let j14 = UInt32(bytes: counter.slice(8..<12)).bigEndian
        let j15 = UInt32(bytes: counter.slice(12..<16)).bigEndian
