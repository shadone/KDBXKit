...
func AESKDF_single() async throws {
    let password = Data("passwordpasswordpasswordpassword".utf8)
    let salt = Data("abcdefghjiklmnopabcdefghjiklmnop".utf8)
    let result = AESKDF.derive(salt: salt, rounds: 1, password)
    #expect(result.hexString == "d3784e35d961f804249296eef568672550caed47ffdcc5ea19ed862553a4f251")
}

@Test
func AESKDF() async throws {
    let password = Data(hexString: "5a77d1e9612d350b3734f6282259b7ff0a3f87d62cfef5f35e91a5604c0490a3")!
